...
| 스킬 | 설명 | 커버 파일 패턴 |
|------|------|---------------|
| `verify-playwright-v2` | playwright-test-v2 에이전트 정의 파일의 구조/패턴/프로토콜 일관성 검증 | `plugins/playwright-test-v2/agents/*.md`, `plugins/playwright-test-v2/skills/playwright-test/SKILL.md` |
| `verify-codebase-review` | codebase-review-v1 에이전트 정의 일관성, 커맨드 동기화, 출력 포맷 검증 | `plugins/codebase-review-v1/skills/codebase-review/SKILL.md`, `plugins/codebase-review-v1/commands/codebase-review.md` |
| `verify-playwright-v1` | playwright-test-v1 플러그인의 에이전트 목록, 출력 경로, 커맨드 동기화, 설정값 일관성 검증 | `plugins/playwright-test-v1/skills/playwright-test/SKILL.md`, `plugins/playwright-test-v1/commands/test.md` |
