...
|---|---|---|---|---|
| [domestic-stock-rights](projects/domestic-stock-rights.md) | `ZkwarjFkN8BiGolWO7PcwI` (반영완료⭐️ 국내주식 권리) | 2026-07-14 | 2026-07-15 | Shipped production reference. Key patterns: detail = bottom sheet (not push nav), always-on bottom disclaimer + global quickmenu nav, single-CTA nav-confirm popups vs two-CTA destructive-confirm, card fields as superset w/ per-type visibility. Re-reviewed 2026-07-15 — corrected several mistranscribed field names/quoted copy and added designer annotations that the first pass missed; see the file's inline `corrected 2026-07-15` notes. |
