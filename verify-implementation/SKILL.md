...
| # | 스킬 | 설명 |
|---|------|------|
| 1 | `verify-playwright-v2` | playwright-test-v2 에이전트 정의 파일의 구조/패턴/프로토콜 일관성 검증 |
| 2 | `verify-codebase-review` | codebase-review-v1 에이전트 정의 일관성, 커맨드 동기화, 출력 포맷 검증 |
| 3 | `verify-playwright-v1` | playwright-test-v1 플러그인의 에이전트 목록, 출력 경로, 커맨드 동기화, 설정값 일관성 검증 |
